<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        ...
        <a wire:navigate href="<?php echo e(route('marketplace.create')); ?>" class="inline-flex items-center px-4 py-2 bg-primary-600 text-white rounded-xl hover:bg-primary-700 transition-colors">
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.empty-state','data' => ['icon' => 'shopping-bag','title' => 'No listings found','description' => 'Be the first to sell something!','action' => ''.e(route('marketplace.create')).'','actionText' => 'Create Listing']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['icon' => 'shopping-bag','title' => 'No listings found','description' => 'Be the first to sell something!','action' => ''.e(route('marketplace.create')).'','actionText' => 'Create Listing']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
    ...
    <?php else: ?>
        <div class="grid grid-cols-2 md:grid-cols-3 gap-4">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $listings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $listing): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a wire:navigate href="<?php echo e(route('marketplace.show', $listing)); ?>">
                    <?php if (isset($component)) { $__componentOriginaldae4cd48acb67888a4631e1ba48f2f93 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginaldae4cd48acb67888a4631e1ba48f2f93 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.ui.card','data' => ['padding' => 'none','class' => 'overflow-hidden hover:shadow-lg transition group h-full']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('ui.card'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['padding' => 'none','class' => 'overflow-hidden hover:shadow-lg transition group h-full']); ?>
                        <div class="aspect-square bg-surface-100 dark:bg-surface-700 relative">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($listing->images && count($listing->images) > 0): ?>
                                <img src="<?php echo e(Storage::url($listing->images[0])); ?>" alt="<?php echo e($listing->title); ?>" class="w-full h-full object-cover">
                            <?php else: ?>
...
<?php $attributes = $attributes->except(\BladeUI\Icons\Components\Svg::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-12 h-12 text-surface-400']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c)): ?>
<?php $attributes = $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c; ?>
...
<?php endif; ?>
                        ...
                        <div class="p-3">
                            <p class="text-lg font-bold text-surface-900 dark:text-white"><?php echo e($listing->formatted_price); ?></p>
                            <h3 class="text-sm text-surface-700 dark:text-surface-300 line-clamp-2 group-hover:text-primary-600 dark:group-hover:text-primary-400"><?php echo e($listing->title); ?></h3>
                            <div class="mt-2 flex items-center text-xs text-surface-500 dark:text-surface-400">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($listing->location_name): ?>
                                    <?php if (isset($component)) { $__componentOriginal643fe1b47aec0b76658e1a0200b34b2c = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal643fe1b47aec0b76658e1a0200b34b2c = $attributes; } ?>
<?php $component = BladeUI\Icons\Components\Svg::resolve([] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php unset($__componentOriginal643fe1b47aec0b76658e1a0200b34b2c); ?>
<?php endif; ?>
                                    <?php echo e(Str::limit($listing->location_name, 20)); ?>
...
<?php /**PATH D:\jason\jasen\Sobaisu\socialapparatus\resources\views/livewire/marketplace/index.blade.php ENDPATH**/ ?>