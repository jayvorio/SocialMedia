<div>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($connectionStatus === 'self'): ?>
            
        <?php elseif($connectionStatus === 'blocked'): ?>
            <span class="inline-flex items-center px-4 py-2 text-sm font-medium text-gray-400 dark:text-gray-500">
                Unavailable
            </span>
        <?php elseif($connectionStatus === 'friends'): ?>
...
<?php /**PATH D:\jason\jasen\Sobaisu\socialapparatus\resources\views/livewire/connections/connection-button.blade.php ENDPATH**/ ?>