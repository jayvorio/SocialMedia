...
<head>
    ...
    <title>{{ config('app.name', 'SocialApparatus') }} Community - Connect with Developers</title>
    ...
    <nav>
        <div class="container nav-container">
            ...
            <div class="nav-links">
                ...
                <a href="https://github.com/jayvorio/SocialMedia" target="_blank">
        ...
        <div class="container">
            <div class="about-grid">
                ...
                <div class="code-card">
                    ...
                    <div class="code-block">
                        <code class="cyan">git clone https://github.com/jayvorio/SocialMedia.git</code>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="section cta-section">
        <div class="container cta-content">
            ...
            <div class="cta-buttons">
                @if (Route::has('register'))
                    <a href="{{ route('register') }}" class="btn btn-primary btn-large">Join the Community</a>
                @endif
                <a href="https://github.com/jayvorio/SocialMedia" target="_blank" class="btn btn-outline btn-large">
        ...
        <div class="container">
            <div class="footer-content">
                ...
                <div class="footer-links">
                    ...
                    <a href="https://github.com/jayvorio/SocialMedia">GitHub</a>
                </div>
            </div>
